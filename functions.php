...
function themeConfig($form) {
    ...
    $toux = new Typecho_Widget_Helper_Form_Element_Text('toux', NULL, NULL, _t('LOGO') , _t('想要啥LOGO？'));
    $form->addInput($toux);
...
$enablekzmb = new Typecho_Widget_Helper_Form_Element_Radio('enablekzmb', array(
    ...
    $kuan = new Typecho_Widget_Helper_Form_Element_Text('kuan', NULL, NULL, _t('瀑布流页面宽度') , _t('默认宽度800px，默认双排显示，想三排或者更多可以增加宽度'));
    $form->addInput($kuan);
